...
export const webAccessibility: Course = {
  ...
  lessons: [
    ...
    },
    {
      kind: "cards",
      id: "barriers",
      label: "Common barriers",
      heading: "Common accessibility barriers",
      intro:
        "Most accessibility problems come from a small number of recurring habits. Select each barrier to see why it excludes people and how to fix it.",
      cards: [
        {
          id: "contrast",
    ...
    },
    {
      ...
      intro:
        "Three short questions to confirm the essentials. You will see feedback after each answer.",
      questions: [
        {
          id: "q1",
        ...
        },
        {
          ...
          choices: [
            ...
            },
            {
              ...
              correct: false,
              rationale:
                "With no alt attribute, many screen readers fall back to reading the file path.",
            },
          ],
          explanation:
